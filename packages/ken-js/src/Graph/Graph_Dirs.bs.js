...
function makeDirs(t) {
  ...
  var partial_arg = Graph_T$Ken.Directory[/* allSubdirectories */7];
  var partial_arg$1 = function (param) {
    return List.map(partial_arg, param);
  };
  var partial_arg$2 = List.filter((function (e) {
          return !Graph_T$Ken.Directory[/* isFactDirectory */6](e);
        }));
  var partial_arg$3 = Graph_T$Ken.Directory[/* parent */9];
